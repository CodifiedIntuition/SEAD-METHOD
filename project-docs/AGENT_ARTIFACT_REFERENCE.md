...
| Task/Command | Generated Document | Output Location | Key Inputs | Consumed By | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `sead plan` / `sead task create-implementation-plan` | Implementation Plan | `sead-workspace/planning/` | Specification, Tech stack description | `sead-scrum-master`, `sead-developer` | The detailed technical plan for implementing a specification. |
| `sead task create-simple-spec` | Simplified Specification | `sead-workspace/specifications/` | User requirements | `sead-architect` (for planning) | A lightweight version of a specification with key requirements and patterns. |
| `*create-backend-architecture` | System Architecture | `docs/sead-architecture.md` | PRD, Catalog patterns | `sead-scrum-master`, `sead-developer`, `sead-qa` | The overall system design, including components, services, and data flow. |
| `*create-front-end-architecture` | Frontend Architecture | `docs/frontend-architecture.md` | PRD, Design System patterns | `sead-developer`, `sead-qa` | The architecture for the user interface and experience. |
| `sead task approve-solution` | Solution Approval Record | `docs/decisions/` | Implementation plan, Story file | `sead-developer`, `sead-qa`, Auditors | A record documenting the formal approval of a proposed technical solution. |
...
| Task/Command | Generated Document | Output Location | Key Inputs | Consumed By | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `*create-ux-spec` | UX Specification | `docs/ux/` | PRD, User research | `sead-architect`, `sead-developer` | A document detailing the user experience, interaction design, and user flows. |
| `*design-system` | Design System Documentation | `sead-catalog/design-system/` | UI components, Style guides | `sead-architect`, `sead-developer` | Documentation for the project's design system, including component usage and tokens. |
...
| Task/Command | Generated Document | Output Location | Key Inputs | Consumed By | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `sead specify` / `sead task create-specification` | Specification | `sead-workspace/specifications/` | User requirements description | `sead-architect` (for planning) | A formal specification document created using the Spec-Kit methodology. |
| `sead task facilitate-brainstorming-session` | Brainstorming Output | `docs/brainstorming/` | Session topic | `sead-product-owner` (for Project Brief/PRD) | Structured output from a brainstorming session, capturing ideas and outcomes. |
| `sead task create-deep-research-prompt` | Research Prompt | `docs/research/` | Research topic | External research tools, other agents | A well-defined, comprehensive prompt for conducting deep research. |
| `sead task document-project` | Project Documentation | `docs/` | Codebase, Specs, Plans | All team members | Generates comprehensive documentation for the project. |
| `sead task index-docs` | Documentation Index | `docs/README.md` | `docs/` directory | All team members | Creates an index file to help navigate the project's documentation. |
...
| Task/Command | Generated Document | Output Location | Key Inputs | Consumed By | Description |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `sead task brownfield-create-story` | Brownfield User Story | `sead-workspace/stories/` | Existing codebase, PRD | `sead-developer`, `sead-qa` | A user story created specifically for a brownfield project, including extracted patterns. |
| `sead task external-asset-analysis` | External Asset Analysis Report | `docs/external-asset-analysis.md` | Staged external assets | `sead-architect` (for integration architecture) | An analysis report on external assets (e.g., design systems, APIs) for integration. |
| `sead task external-adoption-strategy` | External Adoption Strategy | `docs/external-asset-adoption-strategy.md` | Integrated external assets | All team members | A plan for the team to adopt and use integrated external assets. |
| `sead task external-asset-validation` | External Asset Validation Report | `docs/external-asset-validation-report.md` | Integrated external assets | `sead-qa`, `sead-architect` | A report validating that integrated assets meet SEAD constitutional requirements. |
