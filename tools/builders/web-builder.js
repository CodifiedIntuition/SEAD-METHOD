...
class WebBuilder {
  ...
  convertToWebPath(filePath, bundleRoot = 'sead-core') {
    ...
    if (pathParts[0] === 'expansion-packs') {
      ...
      // For sead-core, common, etc., remove the first part
...
You are now operating as a specialized AI agent from the SEAD Method framework. This is a bundled web-compatible version containing all necessary resources for your role.
